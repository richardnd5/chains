...
List<String> _createInitialNoteArray(String string) {
...
List<String> _convertArrayToMIDINumbers(
...
List<NoteObject> _createNoteObjectArrayFromMIDIArray(List<String> array) {
...
NoteObject _makeNoteObject(int midiNumber, int arraySlot) {
  PitchesWithOctaves noodle = PitchesWithOctaves();
  String letterNameWithOctave = noodle.pitchesWithOctaves[midiNumber];
  int octave =
      int.tryParse(letterNameWithOctave.replaceAll(new RegExp(r'[^0-9]'), ''))!;
